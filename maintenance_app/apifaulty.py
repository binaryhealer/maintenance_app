...
existing_intervention = frappe.db.get_value(
    "Mission Intervention",
    {
...
if existing_intervention:
    return {"intervention": existing_intervention}

if mission.custom_mission_status in ["Completed", "Closed"]:
    frappe.throw(
        "This mission is completed. Cannot create a new intervention."
    )
