# Corrected maintenance_app/api.py
# Notes:
# - Last Service Date update is handled in the Mission Intervention After Submit Server Script, not here.
# - This API handles mission/planning creation, wrong equipment/component changes, searches, and invoice creation.
...
def change_mi_equipment(mi_name, actual_equipment, reason):
    ...
    if mi.get("custom_parent_mission"):
        ...
        mission.custom_asset = actual_equipment
        mission.save(ignore_permissions=True)
